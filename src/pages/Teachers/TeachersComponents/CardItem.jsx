      ...
      <div className={style.info}>
        {data.status !== 'defaultTeacher' ?
          <div className={style.cardButtons}>
            {data._id === teacher._id ? <p style={{ color: '#6394B6', fontSize: 14 }}>Вы не можете редактировать и удалить свой аккаунт</p> :
        ...
        <div className={style.top}>
          <div className={style.img}>
            {teacher.avatarUrl !== '' ?
                                          <div className={style.img} style={{ background: `url(http://localhost:5555${teacher.avatarUrl})`, backgroundPosition: 'center', backgroundSize: 'cover', objectFit: 'cover', height: '100%' }}></div> :
              <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#396794" class="bi bi-person-circle" viewBox="0 0 16 16">
