            ...
            <div className={style.right}>
                <div className={style.info}>
                    <div style={{ display: 'flex', justifyContent: 'right' }}>
                        ...
                        {data.status === 'genadmin' &&
                            <svg style={{ marginLeft: 5 }} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-star-fill" viewBox="0 0 16 16">
                ...
                <div className={style.bottons}>
                    <div className={style.avatar}>
                        {data.avatarUrl !== '' ?
                            <div className={style.img} style={{ background: `url(https://codekids-backend-production.up.railway.app${data.avatarUrl})`, backgroundPosition: 'center', backgroundSize: 'cover', objectFit: 'cover', height: '100%' }}></div> :
                    ...
                    <div className={style.headerBtn} onClick={() => onClickLogout()}>
