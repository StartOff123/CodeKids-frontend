                ...
                <Stack spacing={2} sx={{ maxWidth: 350 }} className='form-input'>
                    <div className='form-top'>
                        <div className='form-avatar'>
                            <label>
                                {imageUrl ?
                                    <div style={{ background: `url(https://codekids-backend-production.up.railway.app${imageUrl})`, backgroundPosition: 'center', backgroundSize: 'cover', objectFit: 'cover', height: '100%' }}></div> :
