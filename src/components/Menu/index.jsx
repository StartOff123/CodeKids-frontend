...
const Menu = () => {
    ...
    return (
        <div className={style.menu} style={isVisib ? { width: 222 } : { width: 75 }}>
            ...
            <div className={style.toggleTheme} style={isVisib ? { marginLeft: 0 } : { marginLeft: 8 }}>
                {theme === 'light' ?
                    <div className={style.themeBtn} onClick={handleDarkTheme}>
                    ...
                    <div className={style.themeBtn} onClick={handleLightTheme}>
